...
<body>
    ...
    <div class="ctl-page">
        ...
        <header class="rp-header container">
            <div class="rp-header-inner">
                ...
                <div class="rp-header-center">
                    ...
                    <p class="rp-subtitle">Gyanmanjari Innovative University &nbsp;·&nbsp; Academic Tracking</p>
                </div>
        ...
        <!-- Footer -->
        <footer class="rp-footer text-center" style="margin-top: 10px;">
    ...
    <div class="fab-nav" id="fabNav">
        <div class="fab-menu" id="fabMenu">
            ...
            <a href="ctlactivity" class="fab-link active" id="nav-ctl">
                <svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
